...
export default function App() {
  ...
  if (loading) {
    return (
      <div id="loading-fallback" className="min-h-screen bg-[#f8fafc] flex flex-col justify-center items-center overflow-hidden font-sans">
        {/* Background Mesh Gradients */}
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-indigo-600/5 rounded-full blur-[100px] pointer-events-none"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-indigo-600/5 rounded-full blur-[130px] pointer-events-none"></div>
  ...
  return (
    <div id="application-container" className="min-h-screen bg-[#f8fafc]">
      {user && token ? (
        <JobPortalDashboard 
          user={user} 
          token={token} 
